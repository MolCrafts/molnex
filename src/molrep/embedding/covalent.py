...
# fmt: off — 10-per-row layout mirrors the paper's table; one-per-line kills readability
...
_COVALENT_RADII: tuple[float, ...] = (
    (_MISSING_RADIUS,) + _CORDERO_RADII + (_MISSING_RADIUS,) * (MAX_Z - len(_CORDERO_RADII))
)
